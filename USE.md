...
Paste the following code into the "Import nodes" dialog.
```json
[{"id":"32776004.8f91f","type":"azureiotdevice","z":"6615b69a.328748","deviceid":"","pnpModelid":"","connectiontype":"dps","authenticationmethod":"sas","iothub":"","isIotcentral":true,"scopeid":"","enrollmenttype":"group","saskey":"","certname":"","keyname":"","passphrase":"","protocol":"mqtt","retryInterval":"4","methods":[{"name":"lightOn"},{"name":"sensors*enableSensors"},{"name":"sensors*changeInterval"}],"DPSpayload":"","gatewayHostname":"","caname":"","cert":"","ca":"","x":740,"y":180,"wires":[["c614bf9a.bfe9","12c63560.b421bb"]]},{"id":"c614bf9a.bfe9","type":"debug","z":"6615b69a.328748","name":"Debug output","active":true,"tosidebar":true,"console":false,"tostatus":false,"complete":"true","targetType":"full","statusVal":"","statusType":"auto","x":1020,"y":140,"wires":[]},{"id":"c5cbee63.8acc","type":"inject","z":"6615b69a.328748","name":"Trigger sensor telemetry","props":[{"p":"payload"},{"p":"topic","vt":"str"}],"repeat":"5","crontab":"","once":true,"onceDelay":0.1,"topic":"","payload":"","payloadType":"date","x":260,"y":100,"wires":[["98321138.42501"]]},{"id":"98321138.42501","type":"function","z":"6615b69a.328748","name":"sensor telemetry","func":"msg = {\n    'topic': 'telemetry',\n    'payload': {\n        'battery': Math.floor(Math.random() * 101),\n        'accelerometer': {\n            'x': Math.round((Math.random()*101) * 100000)/100000,\n            'y': Math.round((Math.random()*101) * 100000)/100000,\n            'z': Math.round((Math.random()*101) * 100000)/100000\n        },\n        'gyroscope': {\n            'x': Math.round((Math.random()*101) * 100000)/100000,\n            'y': Math.round((Math.random()*101) * 100000)/100000,\n            'z': Math.round((Math.random()*101) * 100000)/100000\n        },\n        'magnetometer': {\n            'x': Math.round((Math.random()*101) * 100000)/100000,\n            'y': Math.round((Math.random()*101) * 100000)/100000,\n            'z': Math.round((Math.random()*101) * 100000)/100000\n        },\n        'barometer': 850 + (Math.round(35000*Math.random())/100),\n        'geolocation': {\n            \"lat\": Math.round((Math.random()*.1 + 47.6) * 10000)/10000,\n            \"lon\": Math.round((Math.random()*.1 - 122.1) * 10000)/10000,\n            \"alt\": Math.floor(Math.random() * 10001)\n        }\n    },\n    'properties': [\n        {'key':'$.sub', 'value': 'sensors'}\n    ]\n}\nreturn msg;","outputs":1,"noerr":0,"initialize":"","finalize":"","x":490,"y":100,"wires":[["32776004.8f91f"]]},{"id":"31337ada.642326","type":"inject","z":"6615b69a.328748","name":"Trigger root properties","props":[{"p":"payload"},{"p":"topic","vt":"str"}],"repeat":"","crontab":"","once":false,"onceDelay":0.1,"topic":"","payload":"","payloadType":"date","x":210,"y":180,"wires":[["c5d662d9.e8e51"]]},{"id":"c5d662d9.e8e51","type":"function","z":"6615b69a.328748","name":"\"readOnlyProp\" property","func":"msg = {\n    'topic': 'property',\n    'payload': { 'readOnlyProp': 'Node-Red ReadOnlyProp'}\n}\nreturn msg;","outputs":1,"noerr":0,"initialize":"","finalize":"","x":470,"y":180,"wires":[["32776004.8f91f"]]},{"id":"f10e080b.e5c688","type":"function","z":"6615b69a.328748","name":"command response","func":"if (msg.topic == \"command\") {\n   var responseMsg = {\n       \"topic\": \"response\",\n       \"payload\": {\n            \"requestId\": msg.payload.requestId,\n            \"methodName\": msg.payload.methodName,\n            \"status\": 200,\n            \"payload\": msg.payload.payload\n       }\n   };\n   return responseMsg;\n}\n","outputs":1,"noerr":0,"initialize":"","finalize":"","x":830,"y":360,"wires":[["32776004.8f91f","d23a7679.c30678"]]},{"id":"c0620f79.e9d71","type":"function","z":"6615b69a.328748","name":"component properties","func":"\ndelete msg.payload.$version;\nreturn msg;","outputs":1,"noerr":0,"initialize":"","finalize":"","x":820,"y":460,"wires":[["32776004.8f91f","6bdc432d.adb32c"]]},{"id":"f0d3aa72.4fe9a8","type":"comment","z":"6615b69a.328748","name":"IoT Plug and Play Mobile example","info":"This flow show how to use the Azure IOT Device node to connet to Azure IoT Central, using the Plig and Play Mobile device template.","x":818,"y":56,"wires":[]},{"id":"12c63560.b421bb","type":"switch","z":"6615b69a.328748","name":"Switch on topic","property":"topic","propertyType":"msg","rules":[{"t":"cont","v":"command","vt":"str"},{"t":"cont","v":"property","vt":"str"}],"checkall":"false","repair":false,"outputs":2,"x":1040,"y":240,"wires":[["f10e080b.e5c688"],["c0620f79.e9d71"]]},{"id":"acec1054.0ab04","type":"function","z":"6615b69a.328748","name":"device info properties","func":"msg = {\n    'topic': 'property',\n    'payload': { \n        'device_info':{\n            'manufacturer': 'IoT Blackbelt',\n            'model': 'node-red-contrib-azure-iot-device',\n            'swVersion': '0.2.5',\n            'osName': 'Node-Red',\n            'processorArchitecture': 'unknown',\n            'processorManufacturer': 'unknown',\n            'totalStorage': '2048000',\n            'totalMemory': '256000'\n        }\n    }\n}\nreturn msg;","outputs":1,"noerr":0,"initialize":"","finalize":"","x":460,"y":260,"wires":[["32776004.8f91f"]]},{"id":"8d411fb4.d91e3","type":"inject","z":"6615b69a.328748","name":"Trigger device info properties","props":[{"p":"payload"},{"p":"topic","vt":"str"}],"repeat":"","crontab":"","once":false,"onceDelay":0.1,"topic":"","payload":"","payloadType":"date","x":180,"y":260,"wires":[["acec1054.0ab04"]]},{"id":"6bdc432d.adb32c","type":"debug","z":"6615b69a.328748","name":"Debug property","active":true,"tosidebar":true,"console":false,"tostatus":false,"complete":"true","targetType":"full","statusVal":"","statusType":"auto","x":1080,"y":500,"wires":[]},{"id":"d23a7679.c30678","type":"debug","z":"6615b69a.328748","name":"Debug command","active":true,"tosidebar":true,"console":false,"tostatus":false,"complete":"true","targetType":"full","statusVal":"","statusType":"auto","x":1090,"y":400,"wires":[]}]
```